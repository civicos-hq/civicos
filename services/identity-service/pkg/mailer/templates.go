...
// PasswordResetEmail renders the subject/HTML/text triple for the "someone
// requested a password reset" message. Deliberately mentions the "ignore if
// you didn't request this" line — legitimate users get this after clicking
// a button; attackers probing for accounts should hit a dead end.
func PasswordResetEmail(name, resetURL string) (subject, html, text string) {
	displayName := strings.TrimSpace(name)
	if displayName == "" {
		displayName = "there"
	}
	subject = "Reset your CivicOS password"

	text = fmt.Sprintf(
		"Hi %s,\n\n"+
			"Someone asked to reset the password for your CivicOS account.\n"+
			"If it was you, use the link below to choose a new password.\n\n"+
			"Reset your password:\n%s\n\n"+
			"This link expires in 1 hour. If you didn't ask for a reset, ignore\n"+
			"this email — your current password stays active.\n\n"+
			"— CivicOS",
          ...
          <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:12px;box-shadow:0 4px 12px rgba(15,23,42,0.06);overflow:hidden;">
            ...
            <tr>
              <td style="padding:18px 32px 8px;">
                <h1 style="margin:0;font-family:Georgia,'Times New Roman',serif;font-size:24px;line-height:1.25;color:#0f172a;">Reset your password, %s.</h1>
              </td>
            </tr>
            <tr>
              <td style="padding:8px 32px 16px;">
                <p style="margin:0;font-size:15px;line-height:1.55;color:#334155;">Someone asked to reset the password for your CivicOS account. If it was you, use the button below to choose a new one.</p>
              </td>
            </tr>
            <tr>
              <td style="padding:16px 32px 24px;">
                <a href="%s" style="display:inline-block;background:#1f6ed4;color:#ffffff;text-decoration:none;padding:12px 18px;border-radius:8px;font-size:14px;font-weight:600;">Choose a new password</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="padding:0 32px 32px;border-top:1px solid #eef2f7;">
                <p style="margin:20px 0 0;font-size:12px;color:#94a3b8;">This link expires in 1 hour. If you didn't ask for a reset, ignore this email — your current password stays active.</p>
              </td>
            </tr>
          </table>
        </td>
